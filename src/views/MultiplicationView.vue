        ...
        <div class="game-area" v-if="!showGameOver">
          ...
          <div class="problem-container" v-if="currentProblem">
            ...
            <div class="options-container">
              <button
                ...
                :key="index"
                class="option-button"
                :class="{ 'correct': selectedAnswer === index && index === currentProblem.correctIndex,
            ...
            <div v-if="showFeedback" class="feedback" :class="{ 'correct-feedback': isCorrect, 'incorrect-feedback': !isCorrect }">
          ...
          <div class="progress-container">
            ...
            <div class="progress-bar">
              <div
                class="progress-fill"
                :style="{ width: `${totalAnswers > 0 ? (correctAnswers / totalAnswers) * 100 : 0}%` }"
              ></div>
            </div>
          </div>
        </div>
