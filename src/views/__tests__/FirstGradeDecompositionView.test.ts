...
import FirstGradeDecompositionView from '../FirstGradeDecompositionView.vue'

describe('FirstGradeDecompositionView', () => {
  let wrapper: VueWrapper

  beforeEach(() => {
    vi.clearAllMocks()
    setActivePinia(createPinia())
    wrapper = mount(FirstGradeDecompositionView)
  })
  ...
  it('GameOver после всех вопросов', async () => {
