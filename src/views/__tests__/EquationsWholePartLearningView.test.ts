...
vi.mock('@/components/equationsWholePart/EquationsWholePartLearningStory.vue', () => ({
...
import EquationsWholePartLearningView from '../EquationsWholePartLearningView.vue'

describe('EquationsWholePartLearningView', () => {
  let wrapper: VueWrapper

  beforeEach(() => {
    vi.clearAllMocks()
    setActivePinia(createPinia())
    wrapper = mount(EquationsWholePartLearningView)
  })
  ...
  it('показывает заголовок обучения', () => {
    ...
    expect(wrapper.text()).toContain('целое и части')
  })
